...
window.PROJECT = {
  ...
  characters: [
    ...
    { name: "UAE Male, Young", role: "Slim body", status: "next",
      note: "Shares body with Middle. Hair toggle matters most here." },
    { name: "UAE Male, Middle", role: "Slim body", status: "next",
      note: "Shares body with Young." },
    { name: "UAE Male, Old", role: "Bigger body", status: "next",
      note: "Shares body with Elderly. Aging goes around the nose, never over it." },
    { name: "UAE Male, Elderly", role: "Bigger body", status: "next",
      note: "Shares body with Old. Beard still to be confirmed with Daniel." },
  ],
  ...
  groups: [
    {
      ...
      tasks: [
        ...
        { t: "Tripo AI volume reference, view only", s: "next" },
        { t: "Cultural Verification Gate on every reference output", s: "next" },
        { t: "Slim body blockout from approved base, for Young and Middle", s: "next" },
        { t: "Bigger body blockout, for Old and Elderly", s: "next" },
        { t: "Head, Young. Sallat al saif first and locked", s: "next" },
        { t: "Head, Middle. Sallat al saif first and locked", s: "next" },
        ...
        { t: "Refine sculpt and polypaint, four heads, two bodies", s: "next" },
        { t: "Retopo, one UV set per mesh, bake, albedo + mixmap + normal", s: "next" },
        { t: "Shared rig, weight paint, tassel weighted to chest with soft falloff, extreme pose test", s: "next" },
        { t: "SVN handoff with every [EXTENSION] item listed", s: "next" },
      ]
    },
    {
